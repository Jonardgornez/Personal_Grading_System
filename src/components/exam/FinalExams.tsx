...
const FinalExams: React.FC<FinalExamsProps> = ({ subjectId, initialExams }) => {
  ...
  const handleAddExam = async (data: ExamFormValues): Promise<boolean> => {
    const result = await addExam(subjectId, "Final", data);
    if (result.success) {
            ...
            {!ready ? (
              Array.from({ length: 4 }).map((_, i) => (
                <tr key={i}>
                  ...
                  <td className="px-4 py-4"><div className="h-4 w-12 animate-pulse bg-gray-200 rounded" /></td>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <div className="h-7 w-14 animate-pulse bg-gray-200 rounded-md" />
                      <div className="h-7 w-14 animate-pulse bg-gray-200 rounded-md" />
                    </div>
                  </td>
                </tr>
              ...
              <tr>
                ...
                >
                  No final exam entries yet. Add one above.
                </td>
              </tr>
            ) : (
        ...
        {examList.length > 0 && (
          <div className="px-6 py-3 border-t border-gray-50">
            <p className="text-xs text-gray-500">
              <span className="font-semibold text-gray-600">Formula:</span> Final
              Grade = Sum of all final scores ÷ {examList.length}{" "}
