...
interface DeleteParticipationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const DeleteParticipationModal = ({
  isOpen,
  onClose,
  onConfirm,
  performance,
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="px-7 py-6">
          <p className="text-sm text-slate-600">
            ...
            ? This will also remove all student scores for this entry. This
...
export default DeleteParticipationModal;
